...
export default function HeroSection() {
  return (
    <div className="mt-20 mb-30 grid grid-cols-2">
      <div className="mt-auto flex flex-col items-start justify-center gap-8">
        <div className={`${lalezar.className}`}>
          <h1 className="mb-3 text-5xl">Mobile</h1>
          <h2 className="text-7xl text-red-500">Backcover</h2>
          <h2 className="text-7xl text-red-500">Tempered Glass</h2>
        </div>
